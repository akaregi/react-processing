...
const App = () => {
  return (
    <>
      ...
      <p>
        マジでなんかこう、一通り乱数生成を中心に調べてみたんだけど、
        <code>Math.random</code>
        の値によって外向き内向きに棒が伸びるとかそういった法則は見いだせず、そもそもコードの数式全体を雰囲気で処理しているので何処が悪いのかいまいち判然としない。GitHub（フッターにリンクがある）からヘルプを私に投げる権利が貴方に留保されています。
      </p>
      <p>
        ref:&nbsp;
